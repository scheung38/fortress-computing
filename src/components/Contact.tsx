      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-fortress-light/70">
            Contact us to discuss how Fortress Computing can help transform your
            technology landscape and drive your business forward.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label
                      htmlFor="name"
                      className="text-sm text-fortress-light/70"
                    >
                      Full Name
                    </label>
                    <Input
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-fortress-light/70 mb-8 max-w-lg">
              ...
              explore how our expertise can benefit your organization, we're
              here to help.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium text-fortress-light mb-1">
                    Email Us
                  </h4>
                  <a
                    href="mailto:sebastian@fortresscomputing.org"
