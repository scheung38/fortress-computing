...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="section-padding bg-fortress-blue relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why <span className="gradient-text">Fortress Computing</span> is
              Different
            </h2>

            <p className="text-fortress-light/80 mb-8">
              Founded in 2019, Fortress Computing brings together elite
              engineers, data scientists, and technologists with deep experience
              across industries. We specialize in solving complex technical
              challenges that others consider impossible.
            </p>

            <p className="text-fortress-light/80 mb-8">
              Our approach combines rigorous engineering discipline with
              innovative thinking, allowing us to deliver secure, scalable, and
              reliable technology solutions that drive real business outcomes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {strengths.map((strength, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-fortress-light/70">
                    {strength}
                  </span>
                </div>
              ))}
            ...
            >
              <div className="bg-card rounded-lg p-6 md:p-8">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="fortress-card backdrop-blur-sm bg-secondary/50">
                    <h4 className="text-xl font-bold mb-1">6+</h4>
                    <p className="text-sm text-fortress-light/70">
                      Industry Sectors Served
                    </p>
                  </div>
                  <div className="fortress-card backdrop-blur-sm bg-secondary/50">
                    <h4 className="text-xl font-bold mb-1">London</h4>
                    <p className="text-sm text-fortress-light/70">
                      Headquarters
                    </p>
                  </div>
                ...
                <div className="mt-6 p-4 rounded-lg bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20">
                  <blockquote className="mb-2 text-fortress-light/90 italic">
                    "Fortress Computing transformed how we approach technology.
                    Their expertise in both software and hardware engineering
                    made them the ideal partner for our ambitious digital
